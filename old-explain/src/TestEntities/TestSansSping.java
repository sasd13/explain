...
public class TestSansSping {
	...
	public static void main(String[] args)
	{
		...
		User user=new Etudiant(1,"","", "le","thanh",
				new Date("11/04/2014"),"lethanh11_4@hotmail.com",null);
		System.out.println(user.toString());
		
		Professeur prof = new Professeur(2,"","", "Yunes","Jean Baptiste",
				new Date("11/04/2014"),"Yunes.Jean.Baptiste@liafa.fr");
...
/* Exercice(int id,TypeExercice typeExo , int idFeuille,
		...
		Etudiant e1 = new Etudiant(3,"","", "Chroboczeck","Francois", new Date("06/04/2014"),"francois@hotmail.com",null);
		Etudiant e2 = new Etudiant(4,"","", "Nguyen","Ha", new Date("06/04/2014"),"ha@hotmail.com",null);
		Etudiant e4 = new Etudiant(5,"","", "Lacroix","Jean", new Date("07/05/2014"),"jean@hotmail.com",null);
