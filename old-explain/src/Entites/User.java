...
public class User {
	...
	/*
	public User(int id, String login, String auth_serial, String name, String firstName,Date birthday){
		this.id = id;
		this.login = login;
	...
	public User(int id, String login, String auth_serial, String name, String firstName,Date birthday, String email){
		setId(id);
		setLogin(login);
